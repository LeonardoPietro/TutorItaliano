...
change shape by gender/number, and the two most-used verbs — so every later
...
- [x] C'è / Ci sono; basic question words (che cosa, chi, dove, quando, come, perché)

## Milestone
Introduce yourself (name, where you're from, one fact) **and** describe 5
everyday objects with correct gender/article, unaided.
...
- Flashcards created for every new atomic fact (articles, gender rules, essere/avere conjugations).
